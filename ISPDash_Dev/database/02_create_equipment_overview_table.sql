...
INSERT INTO [dbo].[EquipmentOverview] (
    ...
    ('1F-BA0IPRE021', 'AOI檢測機#21', 'RUN', '王曉明', '李秀三', 85.50, 1, 180, GETDATE()),
    ('1F-BA0IPRE031', 'AOI檢測機#22', 'IDLE', '王曉明', '陳小華', 75.25, 2, 150, GETDATE()),
    ('1F-BA0IPRE041', 'AOI檢測機#23', 'DOWN', '王曉明', '王美玲', 45.30, 3, 90, GETDATE()),
    ('2F-BA0IPRE051', '鑽孔機#21', 'RUN', '張志明', '林雅婷', 92.80, 0, 200, GETDATE()),
    ('2F-BA0IPRE061', '鑽孔機#22', 'IDLE', '張志明', '張雅琪', 88.90, 1, 160, GETDATE()),
    ('2F-BA0IPRE071', '鑽孔機#23', 'RUN', '張志明', '吳淑芬', 95.20, 0, 220, GETDATE()),
    ('2F-BA0IPRE081', '鑽孔機#24', 'DOWN', '張志明', '陳雅文', 35.80, 4, 95, GETDATE()),
    ('3F-BA0IPRE091', '壓合機#21', 'RUN', '李明華', '李佳玲', 78.90, 1, 170, GETDATE()),
    ('3F-BA0IPRE101', '壓合機#22', 'IDLE', '李明華', '王雅君', 65.75, 2, 110, GETDATE()),
    ('3F-BA0IPRE111', '壓合機#23', 'RUN', '李明華', '林美玲', 89.70, 0, 190, GETDATE()),
    ('3F-BA0IPRE121', '壓合機#24', 'DOWN', '李明華', '黃志偉', 25.60, 3, 80, GETDATE()),
    ('1F-BA0IPRE131', '曝光機#21', 'RUN', '王曉明', '劉建國', 82.45, 1, 155, GETDATE()),
    ('1F-BA0IPRE141', '曝光機#22', 'IDLE', '王曉明', '張志豪', 70.40, 2, 130, GETDATE()),
    ('2F-BA0IPRE151', '曝光機#23', 'RUN', '王曉明', '陳俊宏', 91.30, 0, 210, GETDATE()),
    ('2F-BA0IPRE161', '曝光機#24', 'DOWN', '王曉明', '林俊傑', 40.20, 3, 85, GETDATE()),
    ('1F-BA0IPRE171', '蝕刻機#21', 'RUN', '張志明', '王建民', 88.50, 1, 165, GETDATE()),
    ('2F-BA0IPRE181', '蝕刻機#22', 'IDLE', '張志明', '趙志偉', 72.30, 2, 125, GETDATE()),
    ('3F-BA0IPRE191', '蝕刻機#23', 'RUN', '張志明', '孫小華', 94.60, 0, 195, GETDATE()),
    ('3F-BA0IPRE201', '蝕刻機#24', 'DOWN', '張志明', '周美玲', 38.90, 4, 88, GETDATE()),
    ('2F-BA0IPRE211', '電鍍機#21', 'RUN', '李明華', '吳雅婷', 87.20, 1, 175, GETDATE());
GO
